...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 31-08-2017 a las 00:08:11
...
(1, 'Sencilla', 1, 100, 'Dolar'),
(2, 'Doble', 2, 200, 'Dolar'),
(3, 'Triple', 3, 250, 'Dolar'),
(4, 'Quadruple', 4, 300, 'Dolar'),
(5, 'Presi', 2, 2000, 'Dolar'),
(6, 'Jr Suit', 1, 500, 'Dolar'),
(7, 'Suit', 2, 1000, 'Dolar');
